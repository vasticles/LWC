...
//		Tween.registerAccessor(ESprite.class, new SpriteAccessor());
	...
	public static Effect createNewEffect(Effect e, Object o) {
		EffectNames name = e.effectName;
		switch(name) {
		case NOEFFECT:
			return new NoEffect(e);
		case OPACITY:
			return new Opacity(e, o);
		case ROTATION:
			return new Rotation(e, o);
		case SCALE:
			return new Scale(e, o);
		case POSITION:
			return new Position(e, o);
		case VELOCITY:
			return new Velocity(e, o);
		default:
			return new NoEffect(e);
		}
	}
