...
public class Velocity extends Effect {
	...
	public Velocity(Object s, Effect e) {
		super(e);
		...
		timeline.push(Tween.set(s, SpriteAccessor.VELOCITY).target(startValueA, startValueB))
				.push(Tween.to(s, SpriteAccessor.VELOCITY, duration).target(
						endValueA, endValueB));
